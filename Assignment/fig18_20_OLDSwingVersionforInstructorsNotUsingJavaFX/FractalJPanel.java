...
public class FractalJPanel extends JPanel
{
   ...
   private static final int WIDTH = 480;  // defines width of JPanel
   private static final int HEIGHT = 480; // defines height of JPanel
   ...
   public void paintComponent(Graphics g)
   {
      ...
      g.setColor(color);
      drawFractal(level, 100, 70, 290, 200, g); 
      drawFractal(level, 10, 70, 90, 20, g); 
